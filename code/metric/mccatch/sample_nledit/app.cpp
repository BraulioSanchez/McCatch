...
public:
   ...
   void Run()
   {
      ...
      // cout << "Define the neighborhood radii ..." << endl;
      ...
      // cout << "oid,name,score,gt" << endl;
      // for (int i = 0; i < P.size(); i++)
      // {
      //    cout << P[i]->GetOID() << "," << P[i]->GetName() << "," << W[i] << "," << y_true[i] << endl;
      // }
