...
if __name__ == '__main__':
	...
	gscores = gen2Out(lower_bound=1, higher_bound=10+1).group_anomaly_scores(X)
	for i in range(len(gscores[0])):
		score = gscores[0][i]
		for indice in gscores[1][i]:
			unbuffered_print('mj%d,%d,%.12f' % (i, indice, score))
